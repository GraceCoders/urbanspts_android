...
class SubCategory_Provider_Adapter(
    val activity: FragmentActivity?,
    providerListing: ArrayList<com.urbanspts.urbanspts.model.SubCategoryModel.ProviderData>
): RecyclerView.Adapter<SubCategory_Provider_Adapter.MyViewHolderFav>() {
    var coverimage:String?=null
    var description:String?=null
    var mLogo:String?=null
    private var providerListing: ArrayList<com.urbanspts.urbanspts.model.SubCategoryModel.ProviderData>? = providerListing
