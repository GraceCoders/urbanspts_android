...
class Category_Provider_Adapter(
    val activity: FragmentActivity?,
    providerListing: ArrayList<ProviderData>
): RecyclerView.Adapter<Category_Provider_Adapter.MyViewHolderFav>() {
    var coverimage:String?=null
    var description:String?=null
    var mLogo:String?=null
    private var providerListing: ArrayList<ProviderData>? = providerListing
